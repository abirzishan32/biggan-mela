...
import { DijkstraStep, GraphData } from './types';
...
export default function GraphVisualization({
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-3">
      ...
      <div 
        ref={containerRef} 
        className="w-full h-[350px] border border-gray-200 dark:border-gray-700 rounded-lg"
      />
    </div>
  );
}