...
import { getBubbleSortSteps, SortStep } from '@/lib/visualizer-adapter';
...
export default function BubbleSortVisualizer() {
  ...
  const startSorting = () => {
    if (array.length === 0 || steps.length === 0) {
      const sortingSteps = getBubbleSortSteps([...array]);
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold text-center mb-8">Bubble Sort Visualization</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2">
          ...
          <SortingAnimation 
            array={currentStep >= 0 ? steps[currentStep].array : array}
            comparingIndices={currentStep >= 0 ? steps[currentStep].comparingIndices : []}
            swappedIndices={currentStep >= 0 ? steps[currentStep].swappedIndices : []}
            isSorting={isSorting}
          />
