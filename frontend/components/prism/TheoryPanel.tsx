...
export default function TheoryPanel() {
  return (
    <div className="mt-4 bg-white p-4 rounded-lg shadow mb-4">
      <h2 className="text-lg font-semibold mb-4">Theory and Principles</h2>
      
      <div className="space-y-4 text-sm">
        <div>
          <h3 className="font-semibold text-indigo-700">Angle of Minimum Deviation</h3>
          <p className="mt-1">
        ...
        <div>
          <h3 className="font-semibold text-indigo-700">Calculating Refractive Index</h3>
          <p className="mt-1">
        ...
        <div className="bg-gray-100 p-3 rounded">
          <h3 className="font-semibold">Experimental Precautions</h3>
        ...
        <div>
          <h3 className="font-semibold text-indigo-700">Physical Significance</h3>
          <p className="mt-1">
