...
import { getMergeSortSteps, MergeSortStep } from '@/lib/visualizer-adapter';
...
export default function MergeSortVisualizer() {
  ...
  const startSorting = () => {
    ...
    if (steps.length === 0) {
      const sortingSteps = getMergeSortSteps([...array]);
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2">
          ...
          <SortingAnimation 
            step={currentStep >= 0 && currentStep < steps.length ? steps[currentStep] : {
              array,
              comparingIndices: [],
              swappedIndices: [],
              subArrayRanges: [[0, array.length - 1]],
              mergingIndices: []
            }}
            isSorting={isSorting}
          />
