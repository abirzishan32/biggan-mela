          ...
          <div className="flex flex-col justify-center space-y-5 relative z-10">
            ...
            >
              <Link href="/dashboard" className="w-full sm:w-auto">
                <Button
                  size="lg"
                  className="group bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 shadow-md shadow-purple-500/20 text-white group h-12 px-6 w-full"
                >
                  {t('button_start')}
              ...
              <Button 
                size="lg" 
                variant="outline" 
                className="group border-border/60 h-12 px-6"
