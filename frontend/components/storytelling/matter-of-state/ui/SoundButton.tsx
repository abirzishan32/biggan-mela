// Meow/Science-game/choto-game/components/storytelling/matter-of-state/ui/SoundButton.tsx
"use client";
...
export default function SoundButton() {
  const { state, toggleSound } = useStory();
  ...
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.9 }}
      aria-label={state.soundEnabled ? "শব্দ বন্ধ করুন" : "শব্দ চালু করুন"}
    >
      {state.soundEnabled ? (
